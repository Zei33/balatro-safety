...
If it's not showing in the marketplace yet, you navigate to your `%AppData%\Balatro\mods` directory (or your OS equivalent) and extract this repo to a folder named `balatro-safety` (or just `git clone git@github.com:Zei33/balatro-safety-balamod.git balatro-safety`).
